...
:::note
If you need to change the schedule after activating it, for example to add a day or update the time, edit the sessions in the editor and click **Save**. Then click **Sync** on the schedule page to apply your changes to future sessions without affecting past ones.
:::
